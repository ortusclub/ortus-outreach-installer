...
// Delete a single past-campaign entry. :idx is the on-disk index in
// history.json (the dashboard preserves it across the newest-first sort),
// matching the convention the rename endpoint already uses.
